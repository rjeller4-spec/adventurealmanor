...
const ACTIVITIES = [
  { id: 1, location: "Lake Almanor", tags: ["boating", "sightseeing"], title: "Sunrise pontoon cruise", desc: "Glass-calm water and a straight-on view of Lassen Peak from the middle of the lake.", gear: "pontoon", hours: 2 },
  { id: 2, location: "Lake Almanor", tags: ["fishing"], title: "Troll for rainbows off Big Springs", desc: "One of the basin's better-known holds for stocked rainbow and brown trout.", gear: "pontoon", hours: 3 },
  { id: 3, location: "Lake Almanor", tags: ["boating", "sightseeing"], title: "Cove-hopping & swim stop", desc: "Anchor up at Rocky Point or Almanor West for a lunch break in the water.", gear: "pontoon", hours: 2.5 },
  { id: 4, location: "Chester", tags: ["sightseeing"], title: "Walk Main Street, Chester", desc: "Coffee, the Saturday market in summer, and the trailhead for the lakeshore path.", gear: null, hours: 1 },
  { id: 5, location: "Chester", tags: ["hiking"], title: "Lake Almanor Recreation Trail", desc: "An easy, mostly flat shoreline walk or ride out of town — good warm-up day.", gear: "bike", hours: 1.5 },
  { id: 6, location: "Westwood", tags: ["biking"], title: "Bizz Johnson Trail", desc: "A converted rail line through Susan River Canyon — long, scenic, and mostly downhill one way.", gear: "bike", hours: 3 },
  { id: 7, location: "Westwood", tags: ["sightseeing"], title: "Paul Bunyan mural & town loop", desc: "A short stretch-the-legs stop with local logging history.", gear: null, hours: 1 },
  { id: 8, location: "Silver Lake", tags: ["hiking", "sightseeing"], title: "Silver Lake basin hike", desc: "Granite backdrop and a much quieter shoreline than Almanor — pack in what you need.", gear: null, hours: 3 },
  { id: 9, location: "Silver Lake", tags: ["fishing"], title: "Shoreline cast for brook trout", desc: "A high-country lake with a different rhythm than the main basin.", gear: null, hours: 2 },
  { id: 10, location: "Mountain Meadows Reservoir", tags: ["fishing", "sightseeing"], title: "Quiet-water fishing", desc: "Lightly pressured water with strong bird life — bring binoculars.", gear: null, hours: 2.5 },
  { id: 11, location: "Mountain Meadows Reservoir", tags: ["boating"], title: "Slow-troll the reservoir", desc: "A mellower alternative to Almanor when you want fewer wakes.", gear: "pontoon", hours: 2 },
  { id: 12, location: "Lassen Volcanic NP", tags: ["hiking", "sightseeing"], title: "Bumpass Hell boardwalk", desc: "The park's signature hydrothermal area — boiling springs, mud pots, steam vents.", gear: null, hours: 2.5 },
  { id: 13, location: "Lassen Volcanic NP", tags: ["hiking"], title: "Lassen Peak summit trail", desc: "A full-day, full-effort hike to 10,457 ft with basin views on a clear day.", gear: null, hours: 6 },
  { id: 14, location: "Lassen Volcanic NP", tags: ["sightseeing"], title: "Highway 89 scenic drive", desc: "The park road itself — pullouts at Sulphur Works, Emerald Lake, and Lake Helen.", gear: null, hours: 2 },
  { id: 15, location: "Chester", tags: ["biking"], title: "Chester climb & coast", desc: "A rolling road ride into the hills above town with a fast return.", gear: "bike", hours: 2 },
  { id: 16, location: "Lake Almanor", tags: ["sightseeing"], title: "Golden-hour photo run", desc: "The Maverick gets you to the east-shore overlooks locals actually use.", gear: "maverick", hours: 1.5 },
  { id: 17, location: "Westwood", tags: ["hiking", "offroading"], title: "Backcountry spur trail", desc: "Reach the trailhead fast by ATV, then hike in past the day-tripper crowd.", gear: "atv", hours: 3 },
  { id: 18, location: "Westwood", tags: ["offroading"], title: "Forest Service road loop", desc: "Miles of graded and rough dirt forest roads north of town — a good shakedown run for the Maverick.", gear: "maverick", hours: 2.5 },
  { id: 19, location: "Chester", tags: ["offroading", "sightseeing"], title: "Ridge-top overlook run", desc: "Climb out of the basin on forest roads to viewpoints over the lake and Lassen Peak.", gear: "maverick", hours: 2 },
  { id: 20, location: "Silver Lake", tags: ["offroading"], title: "Dixie Mountain OHV trails", desc: "Rougher, rockier terrain than the valley roads — best suited to the 4-wheeler.", gear: "atv", hours: 3 },
  { id: 21, location: "Mountain Meadows Reservoir", tags: ["offroading", "sightseeing"], title: "Reservoir rim dirt road", desc: "A quiet dirt road circling the meadow and reservoir, good for wildlife sightings along the way.", gear: "maverick", hours: 2 },
  ...
  { id: 41, location: "Mountain Meadows Reservoir", tags: ["boating"], title: "Launch at Indian Ole Dam", desc: "The reservoir's public boat launch, at the dam off Indian Ole Road — put in here for a slow cruise or a troll for trout and bass.", gear: "pontoon", hours: 2.5 },
  { id: 42, location: "Mountain Meadows Reservoir", tags: ["fishing"], title: "Fish Indian Ole Dam — shore or by boat", desc: "Cast from the bank right at the dam, or launch here and troll for rainbow trout, brown trout, and smallmouth bass across the reservoir.", gear: null, hours: 2.5 },
];
